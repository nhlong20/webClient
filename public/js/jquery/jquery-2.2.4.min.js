...
$(document).ready(function() {
    ...
    rangeSlider.noUiSlider.on('update', function(values, handle) {
        ...
        // document.getElementsByName('minPrice').value = moneyFormat.from(
        //     values[0]);
        // document.getElementsByName('maxPrice').value = moneyFormat.from(
        //     values[1]);
        document.getElementById('minPrice').value = moneyFormat.from(values[0]);
        document.getElementById('maxPrice').value = moneyFormat.from(values[1]);
